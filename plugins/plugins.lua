...
if is_momod(msg) then
  ...
  if matches[1] == 'enable' or matches[1] == 'Enable' and matches[3] == 'chat' then
  ...
  -- Enable a plugin
  if matches[1] == 'enable' or matches[1] == 'Enable' and is_sudo(msg) then --after changed to moderator mode, set only sudo
  ...
  if matches[1] == 'disable' or matches[1] == 'Disable' and matches[3] == 'chat' then
    local plugin = matches[2]
    local receiver = get_receiver(msg)
  ...
  -- Disable a plugin
  if matches[1] == 'disable' or matches[1] == 'Disable' and is_sudo(msg) then --after changed to moderator mode, set only sudo
